/*
    1. Destructuring(비구조화) 문법
     - 객체나 배열의 내부 구조를 분해하여 각가의 값을 변수에 쉽게 할당하는 문법
...
// 2. Spread Operator
// - 배열이나 객체에 담겨있는 값들을 꺼내여 전개해주는 연산자
// - 배열 및 객체에 값을 대입하는 경우, 함수 호출시 자주 사용

const arr2 = [1,2,3,4];
console.log(...arr2);   // ... : 전개 연산자
console.log(arr2);

// spread 연산자를 활용한 배열/객체 복사
const copy_arr = [0,...arr2,5]; // new arr = []
...
function testRest(first,...rest){  //매개변수에서 .. 사용시, 나머지란 뜻
    console.log(first);
    console.log(rest);
}
...
const person2 = {name:'mkm', age: 25 , hobby:['game','movie']};
testRest2(person2);
